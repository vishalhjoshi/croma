...
$(document).ready(function() {
    ...
    $("#id_supplier_id").attr("value", "{{purInvhrd_query.supplier_id.name}}");
    {% if is_create %}
        $("#id_supplier_id").focus();
        $("#cancel").attr("onclick", "location.href='{{prev.get_absolute_purchase_detail_url}}'");
    ...
    {% if is_retrieve %}
        ...
        $("#add").attr("onclick", "location.href='/purchase/create'");
        $("#edit").attr("onclick", "location.href='{{purInvhrd_query.get_absolute_purchase_edit_url}}'");
        {% if prev %}
            $("#prev").attr("onclick", "location.href='{{prev.get_absolute_purchase_detail_url}}'");
        {% else %}
            $("#prev").click(function() {
        ...
        {% if next %}
            $("#next").attr("onclick", "location.href='{{next.get_absolute_purchase_detail_url}}'");
        {% else %}
            $("#next").click(function() {
    ...
    {% if is_update %}
        $("#id_supplier_id").focus();
        $("#cancel").attr("onclick", "location.href='/purchase/create'");
        $("#id_doc_dt").removeAttr("type");
        $("#id_doc_dt").datepicker();
        $("#id_supp_chal_dt").datepicker();
    ...
    {% if is_update %}
    url = "{{purchase_query.get_absolute_purchase_edit_url}}";
    {% else %}
    url = "/purchase/create/";
    {% endif %}
