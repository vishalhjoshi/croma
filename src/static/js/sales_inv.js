...
function populate_amount(is_edit, item_amount_old, item_amount_new){
    ...
    if(is_edit == true){ total_amt = total_amt - item_amount_old + item_amount_new; }
    else{total_amt += item_amt;}
...
$("#delete").click(function(){
    ...
    if (r == true) {
        ...
        $("#delete_ajax_loading").css("display", "inline");
        var doc_no = $("#id_doc_no").val();
        var data = {"csrftoken": csrftoken, "doc_no": doc_no};
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                $("#delete_ajax_loading").css("display", "none");
            },
            error: function(data){
...
$("#search_inv_btn").click(function(){
    ...
    var data = {"csrfmiddlewaretoken" : csrftoken,"sale_inv":sale_inv};
    data = JSON.stringify(data);
    $.ajax({
        type : 'POST',
...
$("#view_inv").click(function(){
    ...
    var data = {"csrfmiddlewaretoken" : csrftoken, "sale_info": sale_info, "sale_item": sale_item};
    data = JSON.stringify(data);
    $.ajax({
        type : 'POST',
        contentType: "application/json; charset=utf-8",
...
$("#edit_doctor").click(function(){
    ...
    var data = {"csrfmiddlewaretoken" : csrftoken,"doctor_name":doctor_name};
    $.ajax({
        type : 'GET',
...
function saveUpdateMethod(url){
    $('#save, #update').click(function(e){
        ...
        if (this.id == 'save')
        $("#save_ajax_loading").css("display", "inline");
        if (this.id == 'update')
        ...
        var data = {"csrfmiddlewaretoken" : csrftoken, "sale_info": sale_info, "item_table": $item_data_set};
        data = JSON.stringify(data);
        $.ajax({
            type : 'POST',
            contentType: "application/json; charset=utf-8",
        ...
        $("#save_ajax_loading").css("display", "none");
