...
$("#search-btn").click(function(){
    ...
    var data = {"csrfmiddlewaretoken" : csrftoken,"search_name":item};
     $.ajax({
        type : 'GET',
...
function loadAutocomlete(params) {
...
$("#edit_salt").click(function(){
    ...
    var data = {"csrfmiddlewaretoken" : csrftoken,"salt_name":salt_name};
    $.ajax({
        type : 'GET',
...
$("#delete").click(function(){
  ...
  if (r == true) {
    ...
    var data = {"csrftoken": csrftoken, "item_name": item_name};
    data = JSON.stringify(data)
    $.ajax({
        type : 'POST',
        contentType: "application/json; charset=utf-8",
